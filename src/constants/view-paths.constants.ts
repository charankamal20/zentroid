...
export const MODELS_GLTF: Record<string, Model> = {
  almirah: {
    ...
    aws_path: "https://zentroid.s3.eu-north-1.amazonaws.com/glb/Almira.glb",
  },
  nike: {
    name: "nike",
    ...
    aws_path:
      "https://d3tz76b3tjibkh.cloudfront.net/glb/Nike+Air+DT+Max+96+Colorado+Away+Sneakers.glb",
  },
  sunglasses: {
    name: "sunglasses",
    ...
    aws_path: "https://d3tz76b3tjibkh.cloudfront.net/glb/DiorSignature.glb",
  },
  sunglasses2: {
    name: "sunglasses2",
    ...
    aws_path: "https://d3tz76b3tjibkh.cloudfront.net/glb/Clubmaster+Way.glb",
  },
  watch: {
    name: "watch",
    ...
    aws_path:
      "https://d3tz76b3tjibkh.cloudfront.net/glb/GRAHAM+FORTRESS+CITY+GMT+RED.glb",
  },
};
